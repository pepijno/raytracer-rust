...
fn main() {
    ...
    let aperture = 0.8;
    let camera = Camera::new(&origin, look_at, vup, field_of_view, ASPECT_RATIO, aperture, focus_distance);
    ...
    for id in 0..THREAD_COUNT {
        ...
        let handle = thread::spawn(move || {
            ...
            let objects: Vec<Shape> = vec![
                ...
                Shape::Sphere(Vector3::new(2.0, 0.0, -6.0), 1.0, ivory),
